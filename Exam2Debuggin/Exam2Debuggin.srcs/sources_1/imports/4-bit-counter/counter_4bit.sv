...
(
    ...
    output logic [3:0] count
        ...
        assign next_count[1] = (~count[1]&~count[0])|(count[1]&count[0]);
        assign next_count[2] = (~count[2]&~count[1]&count[0])|(count[2]&count[0])|(count[2]&count[1]);
        assign next_count[3] = (count[3]&count[2])|(~count[3]&~count[2]&~count[1]&~count[0])|(count[0]&count[3])|(count[1]&count[3]);
        ...
        d_flipflop dff3(
            ...
            .D(dff3_data_i),
            .reset_n(reset_n),
            .Q(count[3])//////count 3 equals q not qn
            );
